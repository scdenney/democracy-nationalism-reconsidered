{\singlespacing\noindent This supplement documents data, measures, measurement-comparability tests, the full multilevel results, robustness checks, and a descriptive longitudinal panel. Section numbers are referenced from the main text. All analyses use ISSP 2023 (ZA10010 v1.0.0); country-level moderators use V-Dem v15 (2023 values).\par}
...
\begin{figure}[H]
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Democratic-rights endorsement and nationalism, by region-regime group (within-country weighted correlations).}]{figures/regional_democratic_rights_heatmap.png}}
...
\begin{figure}[H]
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Perceived democratic performance and nationalism, by region-regime group.}]{figures/regional_democracy_performance_heatmap.png}}
...
\begin{figure}[H]
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Country-specific adjusted slopes for democratic-rights endorsement (with controls), by outcome.}]{figures/country_adjusted_democratic_rights_slopes.png}}
...
\begin{figure}[H]
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={ISSP National Identity 1995--2023. Exclusionary nationalism, West versus non-West (weighted means; composition varies by wave). Panel (A) is the ascriptive (ethnic) conception of nationhood and panel (B) is anti-immigrant exclusion.}]{figures/figS_longitudinal.png}}
...
The replication package \ifanon holds\else is available at \url{https://github.com/scdenney/democracy-nationalism-reconsidered}. It holds\fi the analysis scripts in \texttt{code/} and writes all derived tables and figures to \texttt{outputs/}. The scripts are:
